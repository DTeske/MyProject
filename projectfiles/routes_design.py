...
def change_password():
	...
	description = sends information to server/database and store the new task to the existing username
...
def create_task():
	...
	description = sends information to server/database and store the new password to the existing username
